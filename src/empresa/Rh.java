...
/** Criação da classe derivada RH, que recebe atributos e métodos da classe funcionário */
...
public class Rh extends Funcionario{
	...
	public Rh(String nome, double salarioBase, String email, String endereco, String telefone, String cpf, int idade, Trabalho trabalho) {
